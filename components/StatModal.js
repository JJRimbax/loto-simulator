...
const StatModal = ({ visible, onClose, numeroStats, etoileStats }) => {
    
  const renderStats = (stats, color) => (
    <View style={styles.gridContainer}>
      {stats.map((stat, index) => (
        <View key={index} style={styles.gridItem}>
          <View style={[styles.numberCircle, color === 'blue' ? styles.circleBlue : styles.circleYellow]}>
    ...
    <Modal visible={visible} animationType="slide" transparent={true}>
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          ...
          <Text style={styles.modalTitle}>Tendances des numéros</Text>
          ...
          <ScrollView contentContainerStyle={styles.statsContainer}>
            ...
            {renderStats(etoileStats, 'yellow')}
          </ScrollView>
        </View>
      </View>
    </Modal>
